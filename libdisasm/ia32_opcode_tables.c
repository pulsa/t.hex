...
#define zs NULL  // zero-length string can now be replaced with null pointer (not really)

static const ia32_insn_t tbl_Main[] = {	/* One-byte Opcodes */
...
static const ia32_insn_t tbl_66[] = {	/* SIMD 66 one-byte Opcodes */
	 { idx_660F,  0,   0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   cpu_80386 | isa_GP,   "", "",   0,   0,   0,  0 , 0 }
};


static const ia32_insn_t tbl_F2[] = {	/* SIMD F2 one-byte Opcodes */
	 { idx_F20F,  0,   0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   cpu_80386 | isa_GP,   "", "",   0,   0,   0,  0 , 0 }
};


static const ia32_insn_t tbl_F3[] = {	/* SIMD F3 one-byte Opcodes */
...
static const ia32_insn_t tbl_0F[] = {	/* Two-byte Opcodes */
...
static const ia32_insn_t tbl_660F[] = {	/* SIMD 66 Two-byte Opcodes */
...
static const ia32_insn_t tbl_F20F[] = {	/* SIMD F2 Two-byte Opcodes */
...
static const ia32_insn_t tbl_F30F[] = {	/* SIMD F3 Two-byte Opcodes */
...
static const ia32_insn_t tbl_0F00[] = {	/* Group 6 */
...
static const ia32_insn_t tbl_0F01[] = {	/* Group 7 */
...
static const ia32_insn_t tbl_0F0111[] = {	/* Monitor/MWait opcode */
...
static const ia32_insn_t tbl_0F12[] = {	/* Movlps Opcode */
...
static const ia32_insn_t tbl_0F16[] = {	/* Movhps Opcode */
...
static const ia32_insn_t tbl_0F18[] = {	/* Group 16 */
...
static const ia32_insn_t tbl_0F71[] = {	/* Group 12 */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_660F71[] = {	/* Group 12 SSE */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_0F72[] = {	/* Group 13 */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_660F72[] = {	/* Group 13 SSE */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_0F73[] = {	/* Group 14 */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_660F73[] = {	/* Group 14 SSE */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_0FAE[] = {	/* Group 15 */
...
static const ia32_insn_t tbl_0FBA[] = {	/* Group 8 */
...
static const ia32_insn_t tbl_0FC7[] = {	/* Group 9 */
	 { 0, INS_INVALID,  0,   ARG_NONE,   ARG_NONE,   ARG_NONE,   0,   "", "",   0,   0,   0,  0 , 0 },
...
static const ia32_insn_t tbl_81[] = {	/* Group 1b */
...
static const ia32_insn_t tbl_82[] = {	/* Group 1c */
	 { 0,   INS_ADD,  0,   ADDRMETH_E | OPTYPE_b | OP_W | OP_R,   ADDRMETH_I | OPTYPE_b | OP_SIGNED | OP_R,   ARG_NONE,   cpu_80386 | isa_GP,   "add", "",   0,   0,   0,  INS_SET_ALL, 0 },
	 { 0,   INS_OR,  0,   ADDRMETH_E | OPTYPE_b | OP_W | OP_R,   ADDRMETH_I | OPTYPE_b | OP_R,   ARG_NONE,   cpu_80386 | isa_GP,   "or", "",   0,   0,   0,  INS_SET_ALL, 0 },
	 { 0,   INS_ADD,  0,   ADDRMETH_E | OPTYPE_b | OP_W | OP_R,   ADDRMETH_I | OPTYPE_b | OP_SIGNED | OP_R,   ARG_NONE,   cpu_80386 | isa_GP,   "adc", "",   0,   0,   0,  INS_SET_ALL|INS_TEST_CARRY, 0 },
	 { 0,   INS_SUB,  0,   ADDRMETH_E | OPTYPE_b | OP_SIGNED | OP_W | OP_R,   ADDRMETH_I | OPTYPE_b | OP_SIGNED | OP_R,   ARG_NONE,   cpu_80386 | isa_GP,   "sbb", "",   0,   0,   0,  INS_SET_ALL|INS_TEST_CARRY, 0 },
...
static const ia32_insn_t tbl_83[] = {	/* Group 1d */
...
static const ia32_insn_t tbl_C0[] = {	/* Group 2a */
...
static const ia32_insn_t tbl_C1[] = {	/* Group 2b */
...
static const ia32_insn_t tbl_D0[] = {	/* Group 2c */
...
static const ia32_insn_t tbl_D1[] = {	/* Group 2d */
...
static const ia32_insn_t tbl_D2[] = {	/* Group 2e */
...
static const ia32_insn_t tbl_D3[] = {	/* Group 2f */
...
static const ia32_insn_t tbl_F6[] = {	/* Group 3a */
...
static const ia32_insn_t tbl_F7[] = {	/* Group 3b */
...
static const ia32_insn_t tbl_FE[] = {	/* Group 4 */
...
static const ia32_insn_t tbl_FF[] = {	/* Group 5 */
...
static const ia32_insn_t tbl_D8[] = {	/* FPU D8 */
...
static const ia32_insn_t tbl_D8C0[] = {	/* FPU D8 C0 */
...
static const ia32_insn_t tbl_D9[] = {	/* FPU D9 */
...
static const ia32_insn_t tbl_D9C0[] = {	/* FPU D9 C0 */
...
static const ia32_insn_t tbl_DA[] = {	/* FPU DA */
...
static const ia32_insn_t tbl_DAC0[] = {	/* FPU DA C0 */
...
static const ia32_insn_t tbl_DB[] = {	/* FPU DB */
...
static const ia32_insn_t tbl_DBC0[] = {	/* FPU DB C0 */
...
static const ia32_insn_t tbl_DC[] = {	/* FPU DC */
...
static const ia32_insn_t tbl_DCC0[] = {	/* FPU DC C0 */
	 { 0,  INS_FPU,  0,  ADDRMETH_RF | OPTYPE_fp | OP_W,  ADDRMETH_RF | OPTYPE_fp | OP_R,  ARG_NONE,  cpu_80387 | isa_FPU,  "fadd", "",  0,  0,  0 ,  0 , 0 },
...
static const ia32_insn_t tbl_DD[] = {	/* FPU DD */
...
static const ia32_insn_t tbl_DDC0[] = {	/* FPU DD C0 */
...
static const ia32_insn_t tbl_DE[] = {	/* FPU DE */
...
static const ia32_insn_t tbl_DEC0[] = {	/* FPU DE C0 */
...
static const ia32_insn_t tbl_DF[] = {	/* FPU DF */
...
static const ia32_insn_t tbl_DFC0[] = {	/* FPU DF C0 */
	 { 0, INS_INVALID,  0,  ARG_NONE,  ARG_NONE,  ARG_NONE,  cpu_80387 | isa_FPU,  "", "",  0,  0,  0 ,  0 , 0 },
	 { 0, INS_INVALID,  0,  ARG_NONE,  ARG_NONE,  ARG_NONE,  cpu_80387 | isa_FPU,  "", "",  0,  0,  0 ,  0 , 0 },
	 { 0, INS_INVALID,  0,  ARG_NONE,  ARG_NONE,  ARG_NONE,  cpu_80387 | isa_FPU,  "", "",  0,  0,  0 ,  0 , 0 },
	 { 0, INS_INVALID,  0,  ARG_NONE,  ARG_NONE,  ARG_NONE,  cpu_80387 | isa_FPU,  "", "",  0,  0,  0 ,  0 , 0 },
...
static const ia32_insn_t tbl_0F0F[] = {	/* 3D Now! 0F Suffix */
...
const ia32_table_desc_t ia32_tables[] = {
